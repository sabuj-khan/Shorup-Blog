        ...
        <div class="card px-1 py-1">
            <div class="row justify-content-between ">
                ...
                <div class="align-items-end col" style="text-align:end">
                    ...
                    <a href="{{ url('/addnewpost') }}"><button data-bs-toggle="modal" data-bs-target="#create-modal" class="float-end btn m-0 btn-sm bg-gradient-primary btn-secondary">Add New Post</button></a>
                </div>
            </div>
            <hr class="bg-dark "/>
...
<script>
    ...
    async function getPostList(){
        ...
        let response = await axios.get('/posts-shows');
        ...
        response.data['post'].forEach(function(item, index){
        ...
        $(".editBtn").on('click', async function() {
            ...
            window.location.href = 'http://127.0.0.1:8000/editpost';
        });
